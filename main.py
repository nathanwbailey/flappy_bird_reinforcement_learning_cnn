...
agent = agent.Agent(BATCH_SIZE=32, MEMORY_SIZE=40000, GAMMA=0.99, example_image=state, output_dim=n_actions, action_dim=n_actions, action_dict=action_dict, EPS_START=0.1, EPS_END=0.0001, EPS_DECAY_VALUE=0.999995, TAU = 0.005, lr = 1e-6)
